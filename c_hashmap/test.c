...
//	(void)argv;
    ...
    for (index=0; index<KEY_COUNT; index+=1)
    {
        ...
        snprintf(value->key_string, KEY_MAX_LENGTH, "%s%d", argv[1], index);
        value->number = index;
...
//	dprintf(2, "%d\n", value->number);
    ...
    for (index=0; index<KEY_COUNT; index+=1)
    {
        snprintf(key_string, KEY_MAX_LENGTH, "%s%d", argv[1], index);
    ...
    snprintf(key_string, KEY_MAX_LENGTH, "%s%d", argv[1], KEY_COUNT);
